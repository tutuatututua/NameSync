...
interface CompanyUploadHistoryProps {
  history: UploadHistoryRecord[];
  onRefresh: () => void;
}

export default function CompanyUploadHistory({ history, onRefresh }: CompanyUploadHistoryProps) {
  if (history.length === 0) {
    return (
      <div className="bg-white rounded-lg border border-slate-200 p-6" data-testid="company-upload-history">
        ...
        <div className="text-center py-8 text-slate-500">
          ...
          <p className="text-xs text-slate-400 mt-1">Upload your first Company CSV file</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg border border-slate-200 overflow-hidden" data-testid="company-upload-history">
