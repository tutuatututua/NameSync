...
import { fetchAllCompanyData, fetchCompanyData, CompanyDataRecord, PaginationInfo } from '../../utils/fileParser';

interface CompanyDataTableProps {
  sessionId: string | null;
}

export default function CompanyDataTable({ sessionId }: CompanyDataTableProps) {
